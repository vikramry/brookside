      ...
      <div className="flex flex-row justify-between flex-wrap px-20 sm:px-20 py-16 gap-5">
        <div className="flex flex-col items-start sm:items-start">
          ...
          <div className="mt-4 flex justify-start items-center gap-8 sm:!hidden">
            <Link target="_blank" href={"https://www.instagram.com/Brookside_school.kondapur"} className="text-2xl">
              <FaInstagram />
            </Link>
            <Link target="_blank" href={"https://www.facebook.com/brooksideglobalschool"} className="text-2xl">
              <FaFacebookSquare />
            </Link>
            <Link target="_blank" href={"https://x.com/BrooksideS3384"} className="text-2xl">
              <FaXTwitter />
            </Link>
            <Link target="_blank" href={"https://www.youtube.com/@BrooksideGlobalSchool"} className="text-2xl">
              <FaYoutube />
            </Link>
          </div>
            ...
            <div className="flex flex-col justify-center items-center gap-8 text-sm text-[#2E2B4F] sm:gap-4 sm:text-xl">
              <div className="flex gap-2 justify-start sm:items-center">
                <Link href={"https://www.instagram.com/Brookside_school.kondapur"} target="_blank">
                  <p className="flex justify-start items-center gap-2 sm:pl-1">
                    <FaInstagram />
                    <span>Instagram</span>
                  </p>
                </Link>
